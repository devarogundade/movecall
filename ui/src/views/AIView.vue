...
const Faqs = [
    "What is MoveCall?",
    "Can I Earn with MoveCall?",
    "How to bridge tokens with MoveCall?",
    "What is IOTA LST?",
];
...
const getChats = () => {
    ...
    AI.getChats(walletStore.iotaAddress, (results) => {
        chats.value = results;
...
const sendText = async () => {
    ...
    if (!walletStore.iotaAddress) {
        return notify.push({
            title: "Connect your IOTA wallet!",
    ...
    AI.chat(walletStore.iotaAddress, text.value);
...
<template>
    ...
    <div class="container" v-else>
        <div class="messages" ref="scrollContainer">
            <div class="no_message" v-if="chats.length == 0 || !walletStore.iotaAddress">
                <div class="icon">
                    <AIIcon />
                </div>

                <h3>What can I help you with?</h3>
                <p>Your MoveCall and Interchain AI Assistant.</p>
            </div>

            <div v-show="walletStore.iotaAddress" v-for="chat in chats.sort((a, b) => a.timestampMs - b.timestampMs)"
                :class="chat.from == walletStore.iotaAddress ? 'message message_user' : 'message'">
                <img v-if="chat.from == walletStore.iotaAddress" src="/images/colors.png" alt="">
